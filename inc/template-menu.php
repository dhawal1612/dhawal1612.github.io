 ...
 * @return void
 */
function ironmasslite_main_menu() {
	...
	<nav id="site-navigation" class="<?php echo join( ' ', $classes ); ?>" role="navigation">
		...
		<?php
			$args = apply_filters( 'ironmasslite-theme/menu/main-menu-args', array(
				'theme_location'   => 'main',
				'container'        => '',
				'menu_id'          => 'main-menu',
				'fallback_cb'      => 'ironmasslite_set_nav_menu',
				'fallback_message' => esc_html__( 'Set main menu', 'ironmasslite' ),
			) );
 ...
 * @return void
 */
function ironmasslite_footer_menu() { ?>
	<nav id="footer-navigation" class="footer-menu" role="navigation">
	<?php
		$args = apply_filters( 'ironmasslite-theme/menu/footer-menu-args', array(
			...
			'fallback_message' => esc_html__( 'Set footer menu', 'ironmasslite' ),
		) );
 ...
 * @return string
 */
function ironmasslite_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'ironmasslite-theme/social/list-args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'ironmasslite_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'ironmasslite' ),
	), $context, $type );
 ...
 * @return void
 */
function ironmasslite_set_nav_menu( $args ) {
