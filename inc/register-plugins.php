 ...
 */
add_action( 'tgmpa_register', 'ironmasslite_register_required_plugins' );
/**
 ...
 */
function ironmasslite_register_required_plugins() {
	/*
	...
	$plugins = array(
		array(
			'name'   => esc_html__( 'Jet Plugins Wizard', 'ironmasslite' ),
