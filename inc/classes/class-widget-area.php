...
if ( ! class_exists( 'Ironmasslite_Widget_Area' ) ) {

	class Ironmasslite_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'ironmasslite-theme/widget-area/render', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'ironmasslite-theme/widget_area/rendering_current', $area_id );
			...
			$classes = apply_filters( 'ironmasslite-theme/widget_area/classes', $classes, $area_id );
	...
	function ironmasslite_widget_area() {
		return Ironmasslite_Widget_Area::get_instance();
	}

	ironmasslite_widget_area();
}
