...
if ( ! class_exists( 'CX_Dynamic_CSS_Utilities' ) ) {
	...
	class CX_Dynamic_CSS_Utilities {
		...
		/**
		 * Prepare color to ironmasslitefy.
		 *
		 ...
		 * @since  1.0.0
		 * @param  [string] $color   HEX or RGB(A) color value.
		 * @param  [float]  $percent Ironmasslitefy percent (0-100).
		 * @return array           Prepared color and ironmasslitefy percent.
		 */
		 ...
		 * @param  [array] $mod Optional parameter - pass function name and arg to ironmasslitefy values inside typography array.
		 ...
		 * @param  [array] $mod Optional parameter - pass function name and arg to ironmasslitefy values inside layout array.
		...
		/**
		 * Retrieve a width to swith on ironmasslitele menu from.
		 *
		 * @since  1.0.0
		 * @return int Width value.
		 */
		public function menu_toogle_endpoint() {
			...
			/**
			 * Filters a value when ironmasslitele menu switched.
			 *
			 * @since 1.0.0
